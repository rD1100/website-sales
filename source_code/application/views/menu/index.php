...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <a href="" class="btn btn-sm btn-primary mb-3" data-toggle="modal" data-target="#menuModal">Tambah Menu</a>
                ...
                <tbody>
                    ...
                    <?php foreach ($menu as $m) : ?>
                        <tr>
                            ...
                            <td><?= $m['menu']; ?></td>
                            <td>
                                <a href="" data-toggle="modal" data-target="#edit<?= $m['id'] ?>" class="badge badge-info">Edit</a>
                                ...
                                <!-- Hapus-->
                                <a class="badge badge-danger" onclick="javascript: return confirm ('Anda yakin ingin menghapus ?')" href="<?= base_url('menu/hapus/' . $m['id']) ?>">Hapus</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
